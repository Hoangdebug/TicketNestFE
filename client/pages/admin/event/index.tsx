                ...
                <Box className='p-3'>
                    <div className='pages__events--header d-flex flex-row justify-content-between pb-5'>
                        <div className='position-relative'>
                            ...
                            />
                            <Img
                                className='pages__events--btnSearch'
                                src={images.ICON_SEACH}
                                onClick={() => { }}
                            />
                        </div>
                    ...
                    {totalPage && totalPage > 0 && <Pagination current={currentPage} totalPage={totalPage ?? 0} onPageChange={handleChangePage} />}
                </Box>
            </div>
        </div>
    );
